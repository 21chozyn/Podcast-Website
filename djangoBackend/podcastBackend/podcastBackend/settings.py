"""
Django settings for podcastBackend project.
...
ALLOWED_HOSTS = ["100.25.163.230", "127.0.0.1"]
...
ROOT_URLCONF = "podcastBackend.urls"
...
WSGI_APPLICATION = "podcastBackend.wsgi.application"
